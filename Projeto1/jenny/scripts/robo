...
def recebe(msg):
	global x # O global impede a recriacao de uma variavel local, para podermos usar o x global já  declarado
	global y
	global z
	global id
...
if __name__=="__main__":
    ...
    survivor = rospy.Subscriber("/bump", Bump, recebedor_survivor,queue_size=1) # Recebe se o bumper bateu
